...
OFILES = main.o mylib.o text.o font.o bird.o startScreen.o pipeBody.o pipeNeckTop.o pipeNeckBottom.o gameoverScreen.o background.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h font.h bird.h startScreen.h pipeBody.h pipeNeckTop.h pipeNeckBottom.h gameoverScreen.h background.h
