...
void drawPipe(PIPE *pipe) {
    ...
    if (pipe->col < 0 ) {
        ...
        drawImage3FromCol(pipe->topHeight - pipeNeckHeight, 2, -pipe->col, pipeNeckWidth, pipeNeckHeight,
                          pipeNeckTop);
        drawImage3FromCol(pipe->topHeight + pipe->gapHeight, 2, -pipe->col, pipeNeckWidth, pipeNeckHeight,
                          pipeNeckBottom);
