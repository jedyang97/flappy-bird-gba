...
void drawPipe(PIPE *pipe) {
    ...
    if (pipe->col < 0) {
        ...
        drawImage3FromCol(pipe->topHeight - pipeNeckHeight, 0, -pipe->col-1, pipeNeckWidth, pipeNeckHeight,
                          pipeNeckTop);
        drawImage3FromCol(pipe->topHeight + pipe->gapHeight, 0, -pipe->col-1, pipeNeckWidth, pipeNeckHeight,
                          pipeNeckBottom);
